...
function moverSnake() {
    ...
    if (cabeza.x < 0) {
        cabeza.x = Math.floor(canvas.width / tamCelda) - 1
    } else if (cabeza.x >= canvas.width / tamCelda) {
        cabeza.x = 0
    }
    
    if (cabeza.y < 0) {
        cabeza.y = Math.floor(canvas.height / tamCelda) - 1
    } else if (cabeza.y >= canvas.height / tamCelda) {
        cabeza.y = 0
    }
}
